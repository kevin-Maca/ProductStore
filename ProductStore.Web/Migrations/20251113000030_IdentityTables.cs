    ...
    public partial class IdentityTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductStoreRole", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_ProductStoreRole_ProductStoreRoleId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RolePermission", x => new { x.PermissionId, x.ProductStoreRoleId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RolePermission_ProductStoreRole_ProductStoreRoleId",
                        column: x => x.ProductStoreRoleId,
                        principalTable: "ProductStoreRole",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_ProductStoreRoleId",
                table: "AspNetUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductStoreRole_Name",
                table: "ProductStoreRole",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_RolePermission_ProductStoreRoleId",

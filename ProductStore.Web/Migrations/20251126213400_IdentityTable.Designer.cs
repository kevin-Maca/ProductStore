...
namespace ProductStore.Web.Migrations
{
    ...
    [Migration("20251126213400_IdentityTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProductStore.Web.Data.Entities.RolePermission", b =>
                {
                    ...
                    b.HasKey("PermissionId", "ProductStoreRoleId");
            ...
            modelBuilder.Entity("ProductStore.Web.Data.Entities.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ProductStore.Web.Data.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ProductStore.Web.Data.Entities.RolePermission", b =>
                {
                    b.HasOne("ProductStore.Web.Data.Entities.Permission", "Permission")
